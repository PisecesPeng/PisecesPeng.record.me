...
**command** : 
`tar -xvf[z][j] tarname.tar[.gz][.bz2] filename dirname [--wildcards '*.*']`
...
> **eg.**  
> `target : nc -lp 12345 > source.log`  
> `source : nc -w 1 1.2.3.4 12345 < source.log or nc -v -w 1 1.2.3.4 -z 1-10000`  
